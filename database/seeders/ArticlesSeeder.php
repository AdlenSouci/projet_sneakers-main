...
class ArticlesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('articles')->insert([
            ...
            'img' => 'img/' . 'campus.webp', // Ajoutez le chemin relatif de votre image ici
        ]);
        ...
        DB::table('articles')->insert([
            ...
            'img' => 'img/' . 'sb.webp', // Ajoutez le chemin relatif de votre image ici
        ]);
        ...
        DB::table('articles')->insert([
            ...
            'img' => 'img/' . 'valentine.webp', // Ajoutez le chemin relatif de votre image ici
        ]);
        ...
        DB::table('articles')->insert([
            ...
            'img' => 'img/' . 'panda.webp', // Ajoutez le chemin relatif de votre image ici
        ]);
        ...
        DB::table('articles')->insert([
            ...
            'prix_public' => 150.00,
            'prix_achat' => 75.00,
            'img' => 'img/' . '990.webp', // Ajoutez le chemin relatif de votre image ici
        ]);
        ...
        DB::table('articles')->insert([
            ...
            'prix_public' => 200.00,
            'prix_achat' => 100.00,
            'img' => 'img/' . 'lyte3.webp', // Ajoutez le chemin relatif de votre image ici
        ]);
    }
}
